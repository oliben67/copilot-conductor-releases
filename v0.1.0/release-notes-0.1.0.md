...
- `./setup-0.1.0.sh uninstall` — Clean removal (same effect as `uninstall-conductor.sh`)
- `uninstall-conductor.sh` — Standalone uninstaller (same effect as `setup-0.1.0.sh uninstall`)
